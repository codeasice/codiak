...
UI_TOOLS_METADATA = [
    ...
    {
        "id": "ObsidianStructureAnalyzer",
        "short_title": "Structure Analyzer",
        "long_title": "Obsidian Structure Analyzer",
        "category": "Obsidian",
        "description": "Scan your vault's folder tree to a set depth and get cleanup recommendations.",
        "requires_vault_path": True
    },
    {
